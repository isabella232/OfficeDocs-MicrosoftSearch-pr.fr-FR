...
En outre, le connecteur prend désormais en charge l'analyse des sites web locaux. Pour accéder à vos données sur site, vous devez d'abord installer et configurer l'agent de connecteur Graph. Pour en savoir plus, consultez [l'agent de connecteur Graph.](./on-prem-agent.md)
