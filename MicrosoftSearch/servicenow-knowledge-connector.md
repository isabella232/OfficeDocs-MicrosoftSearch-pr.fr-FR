---
title: Connecteur d’Graph connaissances ServiceNow pour Recherche Microsoft
ms.author: kam1
...
Vous pouvez également consulter [la vidéo suivante pour](https://www.youtube.com/watch?v=TVSkJpk1RiE) en savoir plus sur Graph la gestion des autorisations de recherche par le connecteur de recherche.
...
1. Choisissez **l’option AAD** si l’ID  de messagerie des utilisateurs serviceNow est identique à l’UPN (UserPrincipalName) des utilisateurs dans AAD.
...
ServiceNow Knowledge Graph connector présente les limitations suivantes dans sa dernière version :
